...
*/
include_once('CompraDiretaPagSeguroBoleto_ShortCodeLoader.php');
/**
...
abstract class CompraDiretaPagSeguroBoleto_ShortCodeScriptLoader extends CompraDiretaPagSeguroBoleto_ShortCodeLoader {
    var $doAddScript;
