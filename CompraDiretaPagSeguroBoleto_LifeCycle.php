...
*/
include_once('CompraDiretaPagSeguroBoleto_InstallIndicator.php');
class CompraDiretaPagSeguroBoleto_LifeCycle extends CompraDiretaPagSeguroBoleto_InstallIndicator {
    public function install() {
        ...
        $this->installDatabaseTablesAnPagesCompraDiretaPagSeguroBoleto();
    ...
    public function uninstall() {
        ...
        $this->unInstallDatabaseTablesAnPagesCompraDiretaPagSeguroBoleto();
