...
*/
include_once('CompraDiretaPagSeguroBoleto_OptionsManager.php');
class CompraDiretaPagSeguroBoleto_InstallIndicator extends CompraDiretaPagSeguroBoleto_OptionsManager {
