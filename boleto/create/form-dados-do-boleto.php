...
$post_content = '[form-dados-do-boleto-cdps]';
$post_meta = '[form-dados-do-boleto-cdps]';
$post_title = 'Compra Direta Pag Seguro Boleto';
$post_name = 'form-dados-do-boleto-cdps';
// create page
